-- Source - https://stackoverflow.com/a/13430837
-- Posted by Phil Helix, modified by community. See post 'Timeline' for change history
-- Retrieved 2026-03-10, License - CC BY-SA 3.0
 Use NSHAFTERPDB
 GO
 CREATE PROCEDURE CREATEMODEL_NEW  
(  
     @TableName SYSNAME ,  
