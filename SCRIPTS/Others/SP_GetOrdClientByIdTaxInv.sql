USE [NSERPLIVE]
GO
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[SP_GetOrdClientByIdTaxInv]') AND type IN (N'P', N'PC'))
DROP PROCEDURE [dbo].[SP_GetOrdClientByIdTaxInv]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[SP_GetOrdClientByIdTaxInv]
(
    @OrdClientHdrId INT
)
----With Encryption
