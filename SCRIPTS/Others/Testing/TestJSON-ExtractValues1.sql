...
set @ShaftType = JSON_VALUE(@EnqUpdate, '$.EnqDtl[0].ShaftType')
set @ShaftWidth = JSON_VALUE(@EnqUpdate, '$.EnqDtl[0].ShaftWidth')
set @ShaftDepth = JSON_VALUE(@EnqUpdate, '$.EnqDtl[0].ShaftDepth')
set @EnqProduct = JSON_VALUE(@EnqUpdate, '$.EnqDtl[0].EnqProduct')
...
--SELECT   -- not woring in this program
	--	@ShaftType = ShaftType,
	--	@ShaftWidth = ShaftWidth,
	--	@ShaftDepth = ShaftDepth,
	--	@EnqProduct = EnqProduct
	--FROM OPENJSON(@EnqUpdate, '$.EnqDtl')
	--WITH (
	--	ShaftType NVARCHAR(50)  '$.EnqDtl[0].ShaftType',
	--	ShaftWidth INT          '$.EnqDtl[0].ShaftWidth',
	--	ShaftDepth INT          '$.EnqDtl[0].ShaftDepth',
	--	EnqProduct NVARCHAR(50) '$.EnqDtl[0].EnqProduct'
	--);
