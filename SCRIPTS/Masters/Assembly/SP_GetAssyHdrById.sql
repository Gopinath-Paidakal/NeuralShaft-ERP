USE [NSERPLIVE]
GO
/****** Object:  StoredProcedure [dbo].[SP_GetAssyHdrById]    Script Date: 03/07/2026 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[SP_GetAssyHdrById]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[SP_GetAssyHdrById]
GO
...
CREATE PROCEDURE [dbo].[SP_GetAssyHdrById]
(
	@AssemblyHdrId int = 0 
)
--With Encryption
