USE [NSERPLIVE]
GO
/****** Object:  StoredProcedure [dbo].[SP_InsertDesig]    Script Date: 11/05/20266 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[SP_InsertDesig]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[SP_InsertDesig]
GO

USE [NSERPLIVE]
GO
/****** Object:  StoredProcedure [dbo].[SP_InsertDesig]    Script Date: 11/05/2026  ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO

CREATE PROCEDURE [dbo].[SP_InsertDesig]
(
    @Desig nvarchar(max)
)
----With Encryption
