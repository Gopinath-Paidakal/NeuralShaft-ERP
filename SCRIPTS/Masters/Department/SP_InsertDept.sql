USE [NSERPLIVE]
GO
/****** Object:  StoredProcedure [dbo].[SP_InsertDept]    Script Date: 11/05/20266 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[SP_InsertDept]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[SP_InsertDept]
GO

USE [NSERPLIVE]
GO
/****** Object:  StoredProcedure [dbo].[SP_InsertDept]    Script Date: 11/05/2026  ******/
SET ANSI_NULLS ON
GO
...
BEGIN TRANSACTION;
	...
	(
		...
		FROM OPENJSON(@Department, '$.Department')
		WITH
		(
