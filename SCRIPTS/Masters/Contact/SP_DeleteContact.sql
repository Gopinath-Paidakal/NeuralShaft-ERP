USE [NSERPLIVE]
GO
/****** Object:  StoredProcedure [dbo].[SP_DeleteContact]    Script Date: 04/06/2026 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[SP_DeleteContact]') AND type in (N'P', N'PC'))
