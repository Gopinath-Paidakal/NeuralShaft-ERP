USE [NSERPLIVE]
GO
/****** Object:  StoredProcedure [dbo].[SP_DeleteMenuPermissions]    Script Date: 13/05/2026 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[SP_DeleteMenuPermissions]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[SP_DeleteMenuPermissions]
GO
...
CREATE PROCEDURE [dbo].[SP_DeleteMenuPermissions]
(
	@PermissionsId int
)
----With Encryption
