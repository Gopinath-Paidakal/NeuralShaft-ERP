USE [NSERPLIVE]
GO
/****** Object:  StoredProcedure [dbo].[SP_GetRawMatl]    Script Date: 08/05/2026 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[SP_GetRawMatl]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[SP_GetRawMatl]
GO
...
CREATE PROCEDURE [dbo].[SP_GetRawMatl]
(
