USE [NSERPLIVE]
GO
/****** Object:  StoredProcedure [dbo].[SP_InsertWareHouse]    Script Date: 14/07/20266 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[SP_InsertWareHouse]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[SP_InsertWareHouse]
GO

USE [NSERPLIVE]
GO
/****** Object:  StoredProcedure [dbo].[SP_InsertWareHouse]    Script Date: 14/07/2026  ******/
SET ANSI_NULLS ON
GO
...
BEGIN TRANSACTION;
	...
	INSERT INTO WareHouse
        ...
        FROM OPENJSON(@WareHouse,'$.WareHouse')
        WITH
        (
            WareHouseName NVARCHAR(100),
            WareHouseAddress1 NVARCHAR(100),
            WareHouseAddress2 NVARCHAR(100),
