USE [NSERPLIVE]
GO
/****** Object:  StoredProcedure [dbo].[SP_GetBOMList]    Script Date: 05/05/2026 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[SP_GetBOMList]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[SP_GetBOMList]
GO
...
CREATE PROCEDURE [dbo].[SP_GetBOMList]
--(
