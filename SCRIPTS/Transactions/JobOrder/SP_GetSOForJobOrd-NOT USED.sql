USE [NSERPLIVE]
GO
/****** Object:  StoredProcedure [dbo].[SP_GetSOForJobOrd]    Script Date: 04/04/2026 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[SP_GetSOForJobOrd]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[SP_GetSOForJobOrd]
GO
...
CREATE PROCEDURE [dbo].[SP_GetSOForJobOrd]
(
