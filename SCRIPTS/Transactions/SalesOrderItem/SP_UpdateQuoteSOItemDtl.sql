USE [NSERPLIVE]
GO
/****** Object:  StoredProcedure [dbo].[SP_UpdateQuoteSOItemDtl]    Script Date: 27/07//2026 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[SP_UpdateQuoteSOItemDtl]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[SP_UpdateQuoteSOItemDtl]
GO
...
GO
CREATE PROCEDURE [dbo].[SP_UpdateQuoteSOItemDtl]
(
...
BEGIN TRY
    ...
    UPDATE QDI
        ...
        INNER JOIN OPENJSON(@QuoteSOItemDtl, '$.QuoteSOItemDtl')
        WITH
        (
            QuoteItemDtlId             INT,
            --ItemQuoteHdrId             INT,
