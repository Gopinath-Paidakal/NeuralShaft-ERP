USE [NSERPLIVE]
GO
/****** Object:  StoredProcedure [dbo].[SP_DeletePurchaseOrderDtl]    Script Date: 30/07/20266 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[SP_DeletePurchaseOrderDtl]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[SP_DeletePurchaseOrderDtl]
GO
...
GO
CREATE PROCEDURE [dbo].[SP_DeletePurchaseOrderDtl]
(
