USE [NSERPLIVE]
GO
/****** Object:  StoredProcedure [dbo].[P_DEPARTMENT_DELETE]    Script Date: 17/01/2025 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[P_DEPARTMENT_DELETE]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[P_DEPARTMENT_DELETE]
GO
