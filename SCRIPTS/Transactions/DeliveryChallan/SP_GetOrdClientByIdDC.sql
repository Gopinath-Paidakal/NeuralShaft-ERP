USE [NSERPLIVE]
GO
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[SP_GetOrdClientByIdDC]') AND type IN (N'P', N'PC'))
DROP PROCEDURE [dbo].[SP_GetOrdClientByIdDC]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[SP_GetOrdClientByIdDC]
(
    @OrdClientHdrId INT
)
----With Encryption
