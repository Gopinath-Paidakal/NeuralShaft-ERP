USE [NSERPLIVE]
GO
/****** Object:  StoredProcedure [dbo].[SP_InsertTaxInvDtl]    Script Date: 30/07/20266 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[SP_InsertTaxInvDtl]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[SP_InsertTaxInvDtl]
GO

USE [NSERPLIVE]
GO
/****** Object:  StoredProcedure [dbo].[SP_InsertTaxInvDtl]    Script Date: 30/07/2026  ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[SP_InsertTaxInvDtl]
(
...
BEGIN TRY
    ...
    BEGIN TRANSACTION
           ...
           INSERT INTO TaxInvDtl
            ...
            FROM OPENJSON(@TaxInvDtl,'$.TaxInvDtl')
            WITH
            (
            ...
            Set @TaxInvDtlId = SCOPE_IDENTITY()
