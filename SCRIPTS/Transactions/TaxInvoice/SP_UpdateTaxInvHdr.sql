USE [NSERPLIVE]
GO
/****** Object:  StoredProcedure [dbo].[SP_UpdateTaxInvHdr]    Script Date: 30/07/2026 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[SP_UpdateTaxInvHdr]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[SP_UpdateTaxInvHdr]
GO
...
CREATE PROCEDURE [dbo].[SP_UpdateTaxInvHdr]
(
    @TaxInvHdrId int,
...
BEGIN TRY
	...
	UPDATE H
        SET
            ...
            H.TaxInvTotalAmount         = J.TaxInvTotalAmount,
