USE [NSERPLIVE]
GO
/****** Object:  StoredProcedure [dbo].[SP_GetEnquiryDtlAmt_ById]    Script Date: 11/03/2026 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[SP_GetEnquiryDtlAmt_ById]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[SP_GetEnquiryDtlAmt_ById]
GO
...
CREATE PROCEDURE [dbo].[SP_GetEnquiryDtlAmt_ById]
(
